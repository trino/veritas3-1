                    ...
                    <div class="btn-set pull-right">
                        ...
                        <form action="<?= $this->request->webroot; ?>documents/index" method="get">
                            <select onchange="window.location = $(this).val();" class="form-control input-inline">
                                <option value="<?= $this->request->webroot; ?>documents/index"
                                        <?php if (!isset($_GET['draft'])){ ?>selected="selected"<?php } ?>><?= ucfirst($strings["index_listdocuments"]); ?></option>
                                <option value="<?= $this->request->webroot; ?>documents/index?draft"
                                        <?php if (isset($_GET['draft'])){ ?>selected="selected"<?php } ?>><?= ucfirst($strings["dashboard_drafts"]); ?></option>
                                </option>
                            </select>
                            <?php
                                if (isset($_GET['draft'])) {
                                ...
                                foreach ($type as $t) {
                                    if (!isset($t->show) || $t->show) {
                                        ...
                                        if (isset($return_type) && $return_type == $t->id) {
                                ...
                                foreach ($users as $u) {
                                    ...
                                    if (isset($return_user_id) && $return_user_id == $u->id) {
                                        echo ' selected="selected"';
                                    }
                                ...
                                if ($settings->mee == "MEE") {
                                    ...
                                    foreach ($drcl_d as $drcld) {
                                        ...
                                        if (isset($return_submitted_for_id) && $return_submitted_for_id == $drcld->id) {
                                            echo ' selected="selected"';
                                        }
                                ...
                                foreach ($clients as $c) {
                                    ...
                                    if ($doit) {
                                        ...
                                        if (isset($return_client_id) && $return_client_id == $c->id) {
                                            echo ' selected="selected"';
                                        }
                            ...
                            <button type="submit" class="btn btn-primary input-inline"
                                    id="search"><?= $strings["dashboard_search"]; ?></button>
