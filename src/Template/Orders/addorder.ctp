                                    ...
                                    <?php
                                        ...
                                        if(!isset($client) && !$Viewing){
                                            ...
                                            function printsteps($strings, $CurrentStep, $doc_count){
                                                ...
                                                return '<p style="float:left;font-size:16px;padding:5px 10px 5px 10px;color: #888;background:#f4f4f4;width:120px;text-align: center;margin:0 auto">' . $string . '</p><br style="clear:both;">';
                                            }
