    ...
    <?php
        ...
        function displayform2($DriverProvince, $thedocuments, $name, $theproduct, $did = 0, $_this)
        {
            ...
            if ($did) {
                ...
                if ($thedocuments[$name]["Display"] == 0) {
                    if ($debugmode) {
                        debug("CHECKING: Display setting for " . $name . " is 0");
                    }
                    return false;
            ...
            if (isset($theproduct->BypassForms)) {
                if ($debugmode) {
                    debug("CHECKING: BYPASS FORMS " . $name);
                }
            ...
            if ($debugmode) {
                debug("CHECKING: Driver's province " . $name . " " . $DriverProvince);
            }
        ...
        if (isset($disabled)) { ?>
            <a href="javascript:window.print();"
               class="floatright btn btn-primary"><?= $strings["dashboard_print"]; ?></a>
                            ...
                            <div class="form-wizard">
                                <div class="form-body" style="position: relative;" id="tab0">
                                    ...
                                    <input type="hidden" id="division"
                                           value="<?php if (isset($_GET['division'])) echo $_GET['division']; ?>"/>
                                    <?php
                                        ...
                                        if (!isset($client) && !$Viewing) {
                                            ...
                                            if ($DriverID > 0) {
                                                ...
                                                <div class="steps" id="step0" class="active">
                                                    ...
                                                    <input type="hidden" name="c_id" value="<?php if ($client) {
                                                        echo $client->id;
                                                    } else {
                                                        echo 0;
                                                    } ?>"/>
                                                    ...
                                                    <hr/>
                                                    <a href="javascript:void(0)" id="button0"
                                                       class="buttons btn btn-primary forview"><?= $strings["dashboard_next"]; ?></a>
                                                </div>
                                            ...
                                            foreach ($subdoccli as $sd) {
                                                ...
                                                if (displayform2($DriverProvince, $thedocuments, $d->title, $theproduct, $d->id, $_this)) {//(displayform($DriverProvince, $provinces, $forms, $d->title,$_this)){
                                                    ...
                                                    if (true) { //($prosubdoc['display'] != 0 && $d->display == 1) {
                                                        ...
                                                        $arr_sd[] = $sd->sub_id;
                                                        ?>
                                                        <div class="steps subform_<?php echo $sd->sub_id ?>"
                                                             id="step<?php echo $jj; ?>" style="display:none;">
                                                            ...
                                                            <a href="javascript:void(0)"
                                                               class="buttonprev btn btn-success forview"
                                                               id="buttonprev<?php echo $jj - 1; ?>"><?= $strings["dashboard_previous"] ?></a>
                                                            <a href="javascript:void(0)" id="button<?php echo $jj; ?>"
                                                               class="buttons btn btn-primary forview"><?= $strings["dashboard_next"]; ?></a>
                                                            <?php if ($this->request->params['action'] == 'addorder') { ?>
                                                                <a href="javascript:void(0)"
                                                                   id="draft<?php echo $jj; ?>"
                                                                   class="buttons btn btn-primary"><?= $strings["forms_savedraft"]; ?></a>
                                                            <?php } ?>
                                                        </div>
                                            ...
                                            $jj++;
                                            ?>
                                            <div class="steps confirmationbl" id="step<?php echo $jj; ?>"
                                                 style="display:none;">
                                                <?= printsteps($strings, $doc_count + 2, $doc_count); ?>
                                                <?php include('subpages/documents/confirmation.php'); ?>
                                                <hr/>
                                                <a href="javascript:void(0)" class="buttonprev btn btn-success forview"
                                                   id="buttonprev<?php echo $jj - 1; ?>"><?= $strings["dashboard_previous"] ?></a>
                                                <?php if ($this->request->params['action'] == 'addorder') { ?>
                                                    <a href="javascript:void(0)" id="draft<?php echo $jj; ?>"
                                                       class="buttons btn btn-primary"><?= $strings["forms_savedraft"]; ?></a>
                                                    <a href="javascript:void(0)" id="save<?php echo $jj; ?>"
                                                       class="buttons btn btn-primary"><?= $strings["forms_save"] ?></a>
                                                <?php } ?>
