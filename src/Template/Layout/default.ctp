    ...
    <div class="container"><?php } ?>
        ...
        <div class="page-footer-inner" style="float:right;">
            ...
            //      $isfirst = print_title($content, $this->request->webroot, "pages/view/version_log", "email_log", $isfirst, false, $language);
                    ...
                    $isfirst = print_title($content, $this->request->webroot, "profiles/settings?includeonly=profile/emaillog.php&filename=subpages/readme.html", $strings["dashboard_readme"], $isfirst, true, $language);
                }
            ?>
        </div>
