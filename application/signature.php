...
<div class="panel panel-default">
    <div class="panel-body" id="signature-pad<?= $name; ?>">
        ...
        <div>
            ...
            <input type="button" onclick="save<?= $name; ?>();" id="savebtn<?= $name; ?>" class="btn btn-primary" <?php if(!$savebutton) { echo 'style="display: none"'; } ?> value="Save">
            <!--button class="btn btn-primary" onclick="QuickSave<?= $name; ?>();">Save</button-->
        </div>
    </div>
</div>
