<?php
	if (isset($consent_detail)){
		$Filename = getcwd() . "/canvas/" . $consent_detail->criminal_signature_applicant2;
		if(!file_exists($Filename)){
			$consent_detail->criminal_signature_applicant2 = "";
		}
	}
        ...
        <div class="col-sm-10" style="width: 500px;">
           ...
           <input type="hidden" name="criminal_signature_applicant2" id="criminal_signature_applicant2" />
    		...
    		<div class="links" style="margin-top: 5px;">
                ...
                <?php if(!isset($_GET['form_id'])){?>
    			<a href="javascript:void(0)" onclick='$("#test<?php echo $_GET['num'];?>").data("jqScribble").clear(); $(".touched1").val(0);'>Clear</a>
