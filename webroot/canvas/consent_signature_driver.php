...
<div class="col-sm-12" id="sig1">
    ...
    <?php if($this->request->params['action']!= 'vieworder' && $this->request->params['action']!= 'view'){
        echo '<p style="margin-top:8px;">Please Sign in within the border.</p><div style="width:400px;"><canvas id="test3" style="border: 20px solid silver;border-radius: 5px;"></canvas></div>';
    }?>
