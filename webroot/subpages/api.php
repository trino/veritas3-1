...
function getprovinces($Language = "English", $IncludeUSA = True){
    ...
    switch ($Language){
        case "Acronyms":
            ...
            break;
        case "English":
            $provinces = array("Select Province" . iif($IncludeUSA, "/State"), "Alberta", "British Columbia", "Manitoba", "New Brunswick", "Newfoundland and Labrador", "Northwest Territories", "Nova Scotia", "Nunavut", "Ontario", "Prince Edward Island", "Quebec", "Saskatchewan", "Yukon Territories");
            ...
            break;
        case "French":
            $provinces = array("Choisir la province" . iif($IncludeUSA, "/État"), "Alberta", "Colombie-Britannique", "Manitoba", "Nouveau-Brunswick", "Terre-Neuve-et-Labrador", "Territoires du Nord-Ouest", "Nouvelle-Écosse", "Nunavut", "Ontario", "Île-du-Prince-Édouard", "Québec", "Saskatchewan", "Yukon");
